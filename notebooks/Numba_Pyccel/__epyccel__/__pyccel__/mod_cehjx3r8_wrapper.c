...
PyObject *solve_2d_linearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_2d_linearconv_pyccel(u_dim, u_dim_0001, u, un_dim, un_dim_0001, un, nt, dt, dx, dy, c);
    result = Py_BuildValue("l", Out_0001);
    return result;
}
/*........................................*/

static PyMethodDef mod_cehjx3r8_methods[] = {
    {
...
static struct PyModuleDef mod_cehjx3r8_module = {
    ...
    -1,
    mod_cehjx3r8_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cehjx3r8(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_cehjx3r8_module);
