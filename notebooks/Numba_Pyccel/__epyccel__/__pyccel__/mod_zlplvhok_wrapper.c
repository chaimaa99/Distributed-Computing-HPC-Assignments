...
PyObject *solve_1d_nonlinearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_1d_nonlinearconv_pyccel(u_dim, u, un_dim, un, nt, nx, dt, dx);
    result = Py_BuildValue("l", Out_0001);
    return result;
}
/*........................................*/

static PyMethodDef mod_zlplvhok_methods[] = {
    {
...
static struct PyModuleDef mod_zlplvhok_module = {
    ...
    -1,
    mod_zlplvhok_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zlplvhok(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_zlplvhok_module);
