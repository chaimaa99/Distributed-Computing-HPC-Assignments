...
function solve_1d_burger_pyccel(u, un, nt, nx, dt, dx, nu) result( &
  ...
  do n = 0_C_INT64_T, nt - 1_C_INT64_T, 1_C_INT64_T
    ...
    do i = 1_C_INT64_T, nx - 1_C_INT64_T - 1_C_INT64_T, 1_C_INT64_T
      u(i) = un(i) - un(i) * dt / dx * (un(i) - un(i - 1_C_INT64_T)) + &
      nu * dt / dx ** 2_C_INT64_T * (un(i + 1_C_INT64_T) - 2_C_INT64_T &
