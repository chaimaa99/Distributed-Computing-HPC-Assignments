...
int64_t bind_c_solve_2d_diff_pyccel(int64_t n0_u, int64_t n1_u, double *u, int64_t n0_un, int64_t n1_un, double *un, int64_t nt, double dt, double dx, double dy, int64_t nu);
...
static PyMethodDef mod_ggrvttm1_methods[] = {
    {
...
static struct PyModuleDef mod_ggrvttm1_module = {
    ...
    -1,
    mod_ggrvttm1_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ggrvttm1(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_ggrvttm1_module);
